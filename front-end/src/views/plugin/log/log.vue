...
<script>
    import {getPluginLogFull, getPluginNewLog} from "@/api/log";
    ...
    export default {
      ...
      mounted() {
        new Promise((resolve, reject) => {
          getPluginLogFull(this.pluginName).then(response => {
      ...
      methods:{
        getNewLog(){
          new Promise((resolve, reject) => {
            getPluginNewLog(this.pluginName, this.lineNumber+1).then(response => {
